...
if("FALSE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/justin/ros_test/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/justin/ros_test/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/justin/ros_test/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/justin/ros_test/install/${idir}'.  ${_report}")
    endif()
