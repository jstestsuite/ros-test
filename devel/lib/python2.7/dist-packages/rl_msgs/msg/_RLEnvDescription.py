...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2f().pack(_x.num_actions, _x.num_states))
      ...
      _x = self
      buff.write(_get_struct_2f2B().pack(_x.max_reward, _x.reward_range, _x.stochastic, _x.episodic))
      _x = self.title
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.num_actions, _x.num_states,) = _get_struct_2f().unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.max_reward, _x.reward_range, _x.stochastic, _x.episodic,) = _get_struct_2f2B().unpack(str[start:end])
